...
import PersonnelAbout from "../../pages/Personnel/PersonnelAbout";
import Feedback from "../../pages/Personnel/Feedback";
import doctorImg from "../../assets/images/doctor-img02.png";
import starIcon from "../../assets/images/Star.png";

function Overview({ personnel }) {
  const [tab, setTab] = useState("about");
  return (
    <div className="">
      <h3 className="text-headingColor text-[22px] font-semibold mb-[15px]">
        Overview
      </h3>
        ...
        <div className="grid md:grid-cols-3 gap-[50px]">
          <div className="md:col-span-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-[6px]">
                  <span className="flex items-center gap-[6px] text-[14px] leading-4 lg:text-[16px] lg:leading-7 font-semibold text-headingColor">
                    ...
                    {personnel.totalRating == 0 && personnel.totalRating == 0
                      ? 5
                      : 0}
                  </span>
            ...
            <div className="mt-[50px]">
              ...
              {tab == `feedback` && <Feedback enableFeedBack={false} />}
            </div>
          </div>
        </div>
      </div>
